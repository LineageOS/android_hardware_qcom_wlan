...
enum qca_wlan_vendor_attr_external_acs_event {
	...
	/* Link ID attribute (u8) is used to identify a specific link affiliated
	 * to an AP MLD.
	 */
...
enum qca_wlan_vendor_attr_rropavail_info {
	 ...
	 * information after receiving a QCA_NL80211_VENDOR_SUBCMD_EXTERNAL_ACS
 ...
 * In a command, the user shall specify the quota to be allocated for the
